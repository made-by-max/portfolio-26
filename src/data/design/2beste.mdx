...
Gen-AI assistants were still relatively new when Best'e launched in late 2023, so in addition to these core features, we also introduced a few experiments to improve the Best'e experience.
