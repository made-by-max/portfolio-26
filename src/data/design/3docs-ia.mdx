...
img: docs-featured-image_nhms2n
...
<CldImage
              src="inconsistentHierarchy_tgbdun"
          alt="a screenshot of the auth0 docs"
...
<CldImage
              src="sidebars_knqe3u"
          alt="an image of the new sidebars"
          width="100%"
...
<CldImage
              src="landingpageillustration_xaxp4w"
          alt="a screenshot of the auth0 docs landing page with a simple illustration"
...
<CldImage
              src="landingpagearch_slq2yg"
          alt="a screenshot of the auth0 docs landing page with an architecture diagram"
...
<CldImage
              src="landingpagesimplediagram_l4xskp"
          alt="a screenshot of the auth0 docs landing page with a simple diagram"
...
<CldVideoPlayer
              src="nav-demo_z4orvn"
          alt="a demo of the auth0 navigation in action"
