...
description: A research informed approach to information architecture that improved discoverability by 400%
...
75% of pages had a mismatch between the sidebar and breadcrumbs

21% of pages had either mismatched parent categories or inconsistent hierarchies

54% of pages that were orphaned and didn’t show up in the sidebar navigation
...
<CldImage
              src="taskCardSort_gntuxi"
          alt="a screenshot of the card sorting results"
