...
img: ../../assets/docs-ia/featuredimage.webp
tags:
...
We got a lot of feedback that our docs were amazing. They were frequently cited as a competitive differentiator.

We also got a lot of feedback that our docs were terrible and impossible to navigate.
...
![a screenshot of the auth0 docs](../../assets/docs-ia/hierarchymismatch.webp)
...
![a screenshot of the auth0 docs](../../assets/docs-ia/category-mismatch.webp)

Worst of all, a whopping 54% of pages were orphans that didn't show up in the sidebar navigation at all.

![a screenshot of the auth0 docs](../../assets/docs-ia/orphan.webp)
...
![a screenshot of the card sorting results](../../assets/docs-ia/cardsort-task.webp)
...
![a screenshot of the card sorting results](../../assets/docs-ia/cardsort-feature.webp)
...
![an image of the new sidebars](../../assets/docs-ia/all-nav.webp)
...
![a screenshot of the auth0 docs landing page with a simple illustration](../../assets/docs-ia/landingpage-simple.webp)
...
![a screenshot of the auth0 docs landing page with an architecture diagram](../../assets/docs-ia/landingpage-complex.webp)
...
![a screenshot of the auth0 docs landing page with a simple diagram](../../assets/docs-ia/landingpage-just-right.webp)
